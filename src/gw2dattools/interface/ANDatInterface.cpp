...
namespace gw2dt
{
    namespace datfile
    {
        ...
        ANDatInterfaceImpl::ANDatInterfaceImpl(const char *iDatPath, std::unique_ptr<format::Mft> &ipMft, std::unique_ptr<format::Mapping> &ipMapping) : _datStream(iDatPath, std::ios::binary),
